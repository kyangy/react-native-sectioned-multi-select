...
const defaultColors = {
  ...
  searchPlaceholderTextColor: '#8e8e93',
...
class SectionedMultiSelect extends PureComponent {
  ...
  static defaultProps = {
    ...
    styles: {},
    colors: {},
    itemFontFamily: { fontFamily: Platform.OS === 'android' ? 'Raleway' : 'Raleway', fontWeight: 'bold' },
    subItemFontFamily: { fontFamily: Platform.OS === 'android' ? 'Raleway' : 'Raleway', fontWeight: '400' },
    searchTextFontFamily: { fontFamily: Platform.OS === 'android' ? 'Raleway' : 'Raleway', fontWeight: '400' },
    confirmFontFamily: { fontFamily: Platform.OS === 'android' ? 'Raleway' : 'Raleway', fontWeight: 'bold' },

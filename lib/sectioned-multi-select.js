...
class SectionedMultiSelect extends PureComponent {
  ...
  static defaultProps = {
    ...
    styles: {},
    colors: {},
    itemFontFamily: { fontFamily: Platform.OS === 'android' ? 'Raleway-Regular' : 'Raleway-Regular', fontWeight: 'bold' },
    subItemFontFamily: { fontFamily: Platform.OS === 'android' ? 'Raleway-Regular' : 'Raleway-Regular', fontWeight: '400' },
    searchTextFontFamily: { fontFamily: Platform.OS === 'android' ? 'Raleway-Regular' : 'Raleway-Regular', fontWeight: '400' },
    confirmFontFamily: { fontFamily: Platform.OS === 'android' ? 'Raleway-Regular' : 'Raleway-Regular', fontWeight: 'bold' },
                  ...
                  <View style={styles.center}>
                    {searchIconComponent ?
                      ...
                      <Icon
                        ...
                        style={{ marginHorizontal: 15, color: '#8e8e93' }}
                      />}
                  </View>
                  <TextInput
                ...
                >
                  <View
                    style={[{
                      ...
                      borderRadius: 0,
                      flexDirection: 'row',
                      backgroundColor: '#54B668',
                    },
                    styles.button,
                    ]}
                  >
                    <Text style={[{ fontSize: moderateScale(16), color: '#ffffff' }, confirmFont, styles.confirmText]}>
                      {confirmText}
                    </Text>
                  </View>
                </Touchable>
          ...
          <TouchableWithoutFeedback onPress={this._toggleSelector} disabled={this.state.selector}>
            ...
            >
              <Icon
                size={moderateScale(22)}
                name="search"
                style={{marginRight: moderateScale(10), color: '#8e8e93'}}
              />

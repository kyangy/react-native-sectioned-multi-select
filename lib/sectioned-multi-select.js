...
class SectionedMultiSelect extends PureComponent {
  ...
  static defaultProps = {
    ...
    styles: {},
    colors: {},
    itemFontFamily: { fontFamily: Platform.OS === 'android' ? 'Poppins-Regular' : 'Poppins-Regular', fontWeight: 'bold' },
    subItemFontFamily: { fontFamily: Platform.OS === 'android' ? 'Poppins-Regular' : 'Poppins-Regular', fontWeight: '400' },
    searchTextFontFamily: { fontFamily: Platform.OS === 'android' ? 'Poppins-Regular' : 'Poppins-Regular', fontWeight: '400' },
    confirmFontFamily: { fontFamily: Platform.OS === 'android' ? 'Poppins-Regular' : 'Poppins-Regular', fontWeight: 'bold' },
